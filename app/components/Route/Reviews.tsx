...
export const reviews = [
  ...
  },
  {
    ...
    comment:
      "Tive o prazer de explorar o E-learning, um site que oferece uma extensa gama de cursos sobre vários tópicos relacionados a tecnologia. Fiquei profundamente impressionado com minha experiência.",
  },
  {
    name: "Rosemary Smith",
  ...
  },
  {
    ...
    comment:
      "Junte-se ao E-learning! O E-learning foca em aplicações práticas, em vez de apenas ensinar a teoria por trás das linguagens de programação ou frameworks. Fiz uma aula sobre a criação de um marketplace web usando React JS, e foi muito útil para me ensinar as diferentes etapas envolvidas na criação de um projeto do início ao fim. No geral, recomendo muito o E-learning para quem deseja melhorar suas habilidades de programação e construir projetos práticos. O E-learning é um ótimo recurso que ajudará você a levar suas habilidades para o próximo nível.",
  },
];
